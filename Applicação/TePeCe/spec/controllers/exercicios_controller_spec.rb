  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved exercicio as @exercicio" do
        ...
        post :create, {:exercicio => { "titulo" => "invalid value" }}, valid_session
        assigns(:exercicio).should be_a_new(Exercicio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested exercicio" do
        ...
        Exercicio.any_instance.should_receive(:update).with({ "titulo" => "MyString" })
        put :update, {:id => exercicio.to_param, :exercicio => { "titulo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the exercicio as @exercicio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Exercicio.any_instance.stub(:save).and_return(false)
        put :update, {:id => exercicio.to_param, :exercicio => { "titulo" => "invalid value" }}, valid_session
        assigns(:exercicio).should eq(exercicio)
      end
